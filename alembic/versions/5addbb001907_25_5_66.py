...
def upgrade() -> None:
    ...
    op.create_table('login_logout',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('login', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('turnover_time', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['symbol'], ['stocks.symbol'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('bank_tsc',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('transaction_time', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
